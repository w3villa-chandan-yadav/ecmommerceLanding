  ...
  return (
    ...
    <section className={`w-screen py-8 overflow-hidden ${catogories.bg  ?"bg-gray-200" : "mb-10"}  `}>
        <div className= 'md:w-[89%] w-[95%] lg:w-[80%] mx-auto '>
            ...
            <button className='bg-blue-600 border-collapse text-white md:px-5  px-1 lg:px-8 py-2 text-nowrap  w-full h-full kanit-regular '>{catogories.semi1}</button>
            <button className='md:border-r-[1px] border-collapse border-black text-white md:px-5 px-1 lg:px-8  py-2  w-full kanit-regular'>{catogories.semi2}</button>
            <button className=' hidden lg:block border-black border-collapse text-white   md:px-5 px-1 lg:px-8  py-2  w-full kanit-regular'>{catogories.semi3}</button>
         <button className=' hidden lg:block border-black border-collapse md:border-l-[1px] text-white md:px-5 px-1 lg:px-8  py-2 w-full  kanit-regular'>{catogories.semi4}</button>
    ...
    className={`h-full w-full swiper_first`}>
     ...
     {  isTrue &&( <>   <SwiperSlide className='w-full h-full  rounded-lg overflow-hidden relative'>
             <div className='w-full h-[90%]   bg-white flex flex-col justify-between '> 
                         ...
                         <div className='border-b-2 border-gray-200 px-2'>
                              <h3 className='text-black  text-sm font-light'> Bodycom Dress  s</h3>
        ...
        [1,2,3,4,5].map((_,index)=>{
            return(
                ...
                <div className='w-full h-[90%] rounded-lg overflow-hidden relative'>
                              <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmjS8ywMSOb3KUk39Ta5Ro3xb9yM6P8TLbdw&s' alt='' className='w-full h-full object-cover object-center'/>
                              <h3 className='bg-white rounded-sm text-black  absolute bottom-3 px-3  left-[50%] translate-x-[-50%] cursor-pointer'>FASHION {index}</h3>
                          </div>
                  </SwiperSlide>
            )
        })
