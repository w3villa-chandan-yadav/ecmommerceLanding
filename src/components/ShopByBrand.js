  ...
  return (
    <section className='w-screen h-full overflow-hidden'>
        <div className='w-[85%] mx-auto py-10'>
            ...
            <div className='grid grid-cols-3 md:grid-cols-5 lg:grid-cols-7 gap-3 mt-5'>
            {/* The last on is not getting center when we use grid */}


                <div className='hidden lg:block border-[1px] border-gray-600 p-2 lg:h-[150px] lg:w-[150px] '>
                ...
                <div className='hidden md:block lg:block border-[1px] border-gray-600 p-2 lg:h-[150px] lg:w-[150px] h-[85px] w-[85px] '>
                ...
                <div className='border-[1px] border-gray-600 p-2 lg:h-[150px] lg:w-[150px] h-[85px] w-[85px] '>
               ...
               {/* This on not getting center */}
                <div className='hidden md:block border-[1px] border-gray-600 p-2 lg:h-[150px] lg:w-[150px] h-[85px] w-[85px] '>
                    <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ62ChstFudVi6093NAWexrHD7j88tNDDXkaQ&s' alt='brand-1' className='w-full h-full object-center object-cover'/>
                </div>
